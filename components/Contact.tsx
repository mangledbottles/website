            ...
            <div className="card">
                ...
                <article className="message is-dark">
                    <div className="message-body">
                        <h1>Get in touch :)</h1>
                        <h3>Email <a href="mailto:contact@dermotobrien.me">contact@dermotobrien.me</a></h3>
                        <h3><a href="emailpublickey.asc" target="_blank">Download PGP Public Key </a></h3>
                        <br />


                        <a href="https://github.com/mangledbottles" target="_blank">
                        ...
                        <a href="https://linkedin.com/in/dermotob" target="_blank">
                            <button className="button">
                                <span className="icon">
